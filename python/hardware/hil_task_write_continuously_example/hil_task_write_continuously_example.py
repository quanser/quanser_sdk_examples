#################################################################
#
# hil_task_write_continuously_example.py - Python file
#
# This example writes from analog channels 0 and 1, and encoder channels 0 and 1,
# every 0.5 seconds. It continues to write until Ctrl-C is pressed.
#
...
try:
    ...
    try:
        ...
        print("and sine waves to the first two analog output channels at %g Hz continuously." % frequency)
