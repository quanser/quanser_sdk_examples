#################################################################
#
# position_control_example.py - Python file
#
...
try:
    ...
    try:
        ...
        print("This example controls the Quanser SRV-02 experiment at %g Hz." % frequency)
        ...
        while samples_read > 0 and stop == False:
            ...
            position    = counts[0] * 360 / 4096 # convert counts to degrees
